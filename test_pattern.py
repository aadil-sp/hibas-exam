...
class BLEPrinter:
    ...
    async def print_patterns(self):
        ...
        # We will print 3 blocks, 15 packets each
        total_packets = 45
        ...
        # Block 1: Alternating bytes (0x55) - No null bytes
        print("Sending Block 1 (0x55 pattern - no nulls)...")
        ...
        # Block 2: Half 0x55, Half 0x00 (contains null bytes at the end)
        ...
        # Block 3: Solid borders, nulls in between (like our borders that didn't print)
